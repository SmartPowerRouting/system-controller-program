...
#define LCD_POWER_X 168
#define LCD_MMC_Y 128
#define LCD_BKUP_Y 180
...
#define LCD_SYS_STAT_BOX_Y 56
#define LCD_SYS_STAT_BOX_WIDTH (LCD_Width - 32)
#define LCD_SYS_STAT_BOX_HEIGHT 28
