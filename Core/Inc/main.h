...
#define ADC_IMMC_Pin GPIO_PIN_3
#define ADC_IMMC_GPIO_Port GPIOA
#define ADC_IBKUP_Pin GPIO_PIN_4
#define ADC_IBKUP_GPIO_Port GPIOA
#define ADC_IOUT_Pin GPIO_PIN_5
